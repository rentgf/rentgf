...
export const metadata: Metadata = {
  ...
  keywords: [
    'rent a girlfriend India',
    'companion app India',
    'female companion Delhi',
    'female companion Mumbai',
    'female companion Bengaluru',
    'social companion India',
    'companionship app India',
    'rent girlfriend Delhi',
    'rent girlfriend Mumbai',
    'paid companionship India',
    'platonic companion India',
    'coffee companion India',
    'travel companion India',
    'event companion India',
    'female companion Hyderabad',
    'female companion Chennai',
    'female companion Pune',
    'companionship service India',
    'rentgf',
  ],
