...
export default function AdminReportsPage() {
  ...
  async function load() {
    ...
    const { data } = await supabase
      .from('reports')
      .select('id, reason, description, status, created_at, reporter:profiles!reporter_profile_id(display_name), reported:profiles!reported_profile_id(display_name)')
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 text-xs text-[#738078]">{report.reason}</p>
                      {report.description && (
